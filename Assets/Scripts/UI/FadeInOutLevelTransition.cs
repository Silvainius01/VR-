...
public class FadeInOutLevelTransition : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (FinishedFading == false)
        {
            ...
            if (FadeIn == true)
            {
                if (HadDelay == false && tracker.GetComponent<LevelTracker>().StartFadeIn == true)
                {
        ...
        {
            if (TheNextLevel != null) SceneManager.LoadScene(TheNextLevel);
        }
    }
