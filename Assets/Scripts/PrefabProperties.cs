...
public class PrefabProperties : MonoBehaviour {
	...
	/*public ArrayList PropertyNameLerp1 = new ArrayList();
	public ArrayList PropertyFloatLerp1 = new ArrayList();
	public ArrayList PropertyColorLerp1 = new ArrayList();
	public ArrayList PropertyVector2Lerp1 = new ArrayList();
	public ArrayList PropertyVector3Lerp1 = new ArrayList();
	public ArrayList PropertyVector4Lerp1 = new ArrayList();
	public ArrayList stdVector2Lerp1 = new ArrayList();
	public ArrayList stdVector3Lerp1 = new ArrayList();
	public ArrayList stdColorLerp1 = new ArrayList();*/
	/*public ArrayList PropertyNameLerp2 = new ArrayList();
	public ArrayList PropertyFloatLerp2 = new ArrayList();
	public ArrayList PropertyColorLerp2 = new ArrayList();
	public ArrayList PropertyVector2Lerp2 = new ArrayList();
	public ArrayList PropertyVector3Lerp2 = new ArrayList();
	public ArrayList PropertyVector4Lerp2 = new ArrayList();
	public ArrayList stdVector2Lerp2 = new ArrayList();
	public ArrayList stdVector3Lerp2 = new ArrayList();
	public ArrayList stdColorLerp2 = new ArrayList();*/
	...
	void Update () 
	{
		if (lerpToggle)
		{
			float lerp = Mathf.PingPong(Time.time, 2) / 2;
				...
				{
					Color curlerp1Emission = PropertyColorLerp1[0];
					Color curlerp2Emission =  PropertyColorLerp2[0];
