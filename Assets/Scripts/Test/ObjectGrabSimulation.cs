...
public class ObjectGrabSimulation : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        GrabedObjectStart = TestChildObject.GetComponent<EquipObject>().FixedEquipedPosition;
        TestChildObject.transform.localRotation = Quaternion.Euler(TestChildObject.GetComponent<EquipObject>().FixedEquipedRotation.x, TestChildObject.GetComponent<EquipObject>().FixedEquipedRotation.y, TestChildObject.GetComponent<EquipObject>().FixedEquipedRotation.z);
    }
